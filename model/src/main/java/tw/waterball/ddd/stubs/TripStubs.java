...
public class TripStubs {
    public static Trip PICKING_TRIP = new Trip("999", MatchStubs.COMPLETED_MATCH);
    public static Trip DRIVING_TRIP;

    static {
        DRIVING_TRIP = new Trip("999", MatchStubs.COMPLETED_MATCH);
    ...
    static {
        ARRIVED_TRIP = new Trip("999", MatchStubs.COMPLETED_MATCH);
